...
window.I18N_STRINGS = Object.assign(window.I18N_STRINGS || {}, {
  ...
  // Compact form for the chapter-view header, where the full one wraps.
  'tl.chars_from_short': { en: 'from {n}', ja: '{n}字〜' },
  ...
  'tl.regen_summary': { en: 'Rebuild this chapter summary', ja: '要約を作り直す' },
  'tl.regen_summary_confirm': { en: 'Rebuild this chapter\'s AI summary? (uses API credit)', ja: 'この章の要約をAIで作り直しますか？（API利用料がかかります）' },
  ...
  'tl.chapter_no_summary_yet': { en: "This chapter's summary hasn't been generated yet", ja: 'この章の要約はまだ生成されていません' },
  'tl.prev_chapter': { en: 'Previous', ja: '前の章' },
  'tl.next_chapter': { en: 'Next', ja: '次の章' },
  // Detachable panel windows (visionOS).
  'tl.pop_out_window': { en: 'Open in its own window', ja: '別ウインドウで開く' },
  'tl.panel_no_title': { en: 'No book is open in the main window.', ja: 'メインウインドウで本が開かれていません。' },
  'tl.panel_mount_failed': { en: 'Nothing to show here yet.', ja: 'まだ表示できるものがありません。' },

  // Blank chapter page (a chapter you paged to that has no summary yet).
  'tl.gen_summary_cta': { en: '✦ Generate summary', ja: '✦ 要約を生成' },
  'tl.blank_page_hint': { en: 'Use ‹ › below to move to other chapters’ summaries.', ja: '下の ‹ › で他の章の要約に移動できます。' },
  'tl.gen_summary_confirm': { en: 'Generate this chapter’s summary with AI? (uses your API credit)', ja: 'この章の要約をAIで生成しますか？（API利用料がかかります）' },
  'tl.quotes_heading': { en: 'Quotes', ja: '引用' },
  'tl.vocab_heading': { en: 'Vocabulary', ja: '語彙' },
  ...
  'tl.spoiler_confirm': { en: "This chapter isn't finished yet — the summary may contain spoilers. Generate anyway?", ja: 'この章はまだ読み終えていません。要約にはネタバレが含まれる可能性があります。生成しますか？' },
  // ---- feed image viewer (lightbox footer) ----
  'tl.regenerate_image': { en: 'Regenerate', ja: '再生成' },
  'tl.delete_image_confirm': { en: 'Delete this image?', ja: 'この画像を削除しますか？' },
  'tl.always_use_model': { en: 'Always use this model', ja: '常にこのモデルを使用' },
  'tl.loading_models': { en: 'Loading models…', ja: 'モデルを読み込み中…' },
  // ---- vocab review (in-app SRS, vocab-srs.js) ----
  'vs.title': { en: 'Vocab review', ja: '語彙の復習' },
  'vs.review_btn': { en: 'Vocab', ja: '語彙' },
  'vs.add': { en: 'Add to review', ja: '復習に追加' },
  'vs.remove': { en: 'Remove from review', ja: '復習から削除' },
  'vs.added': { en: 'Added to review', ja: '復習に追加しました' },
  'vs.removed': { en: 'Removed from review', ja: '復習から削除しました' },
  'vs.show_answer': { en: 'Show answer', ja: '答えを見る' },
  'vs.again': { en: 'Again', ja: 'もう一度' },
  'vs.good': { en: 'Good', ja: 'OK' },
  'vs.done': { en: 'All done!', ja: '復習 完了！' },
  'vs.none_saved': { en: 'No saved words yet (use ＋ on a chapter\'s vocab cards)', ja: '保存された語彙がありません（章の語彙カードの ＋ で追加）' },
  'vs.ahead_note': { en: 'Nothing due — reviewing ahead', ja: '期限の復習はありません — 先取りで復習します' },
  'vs.hub_counts': { en: 'Due today: {due} · Saved words: {total}', ja: '今日の復習: {due}件 · 保存語彙: {total}語' },
  'vs.start': { en: 'Start review', ja: '復習を始める' },
  'vs.freq': { en: 'Review frequency', ja: '復習の頻度' },
  'vs.freq_more': { en: 'More often', ja: '多め' },
  'vs.freq_std': { en: 'Standard', ja: '標準' },
  'vs.freq_less': { en: 'Less often', ja: '少なめ' },
  'vs.freq_note': { en: 'Applies to how fast intervals grow (from the next grade)', ja: '間隔の伸び方に反映されます（次の採点から）' },
