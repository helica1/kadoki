...
<p align="center">
  A Japanese learning app for <strong>narrated reading</strong>, <strong>audiobook immersion</strong>, <strong>dictionary lookup</strong>, and <strong>Anki integration</strong>.
</p>
